...
% 	N     		: fft length
%
%   DSP Builder v2.0.0 - $Revision: 1.2 $ 
%	Copyright (C) 2001-2002 Altera Corporation
%
%$Header: /cvs/uksw/quartus/dsp_builder2/Documentation/DesignExamples/Demos/Filters/IIROrder2/fftplot.m,v 1.2 2007/04/24 09:28:26 lkong Exp $
function fftplot(data,fs,color,N)
